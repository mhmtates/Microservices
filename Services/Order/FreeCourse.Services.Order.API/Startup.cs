        ...
        public void ConfigureServices(IServiceCollection services)
        {
            services.AddMassTransit(x =>
            {
                ...
                x.UsingRabbitMq((context, cfg) =>
                {
                    ...
                    cfg.ReceiveEndpoint("course-name-changed-event-order-service", f =>
                    {
                        f.ConfigureConsumer<CourseNameChangedEventConsumer>(context);
                    });
            ...
            services.AddDbContext<OrderDbContext>(opt =>
            {
                opt.UseSqlServer(Configuration.GetConnectionString("DefaultConnection"), configure =>
                 {
                     configure.MigrationsAssembly("FreeCourse.Services.Order.Infrastructure");//Bu katmanda migrations klasörünü oluþtur.
                 });
