...
namespace FreeCourse.WebUI.Services.Concrete
{
    public class IdentityService : IIdentityService
    {
        ...
        public async Task<Response<bool>> SignIn(UserInput userinput)
        {
            var discovery = await _httpClient.GetDiscoveryDocumentAsync(new DiscoveryDocumentRequest
            {
                Address = _serviceApiSettings.IdentityBaseUri,
            ...
            if (token.IsError)
            {
                ...
                var error = JsonSerializer.Deserialize<ErrorDto>(responseContent, new JsonSerializerOptions
            ...
            authenticationProperties.IsPersistent = userinput.IsRemember;
