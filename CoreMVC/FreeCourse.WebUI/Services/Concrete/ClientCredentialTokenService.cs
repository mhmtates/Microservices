...
{
    public class ClientCredentialTokenService : IClientCredentialTokenService  //Token'ı memory'ye kaydetmek için bu akış tipini kullanıyoruz. 
    {
        ...
        public async Task<string> GetToken()
        {
            ...
            await _clientAccessTokenCache.SetAsync("WebClientToken", newToken.AccessToken, newToken.ExpiresIn);//Token'ı cacheledik. 
